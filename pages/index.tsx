...
> = ({ children, label, className }) => (
  <div className={clsx("p-4 sm:pb-16 sm:px-6 w-full lg:px-20", className)}>
    <h1 className="text-2xl font-semibold tracking-wider text-gray-700 mb-3">
      {label}
    </h1>
    <div className="grid grid-cols-1 gap-14 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 xl:gap-x-8">
      {children}
    </div>
  </div>
);
